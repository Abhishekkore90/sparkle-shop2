    ...
    <div className="bg-white font-sans selection:bg-primary/20">
      ...
      <section className="bg-white py-12">
        <div className="container-xl">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              { title: "SPARKLE AutoSoft", image: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80&w=600", category: "water-softeners" },
              { title: "SPARKLE AutoSoft 8L", image: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80&w=600", category: "water-softeners" },
